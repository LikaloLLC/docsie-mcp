...
Access is scoped by Docsie user or service credential, organization, selected workspace, workspace membership, and permission pack. A connected MCP client does not receive global access to all Docsie data.
